...
**Requires a GitHub account and a Cloudflare account.** Both are free, and don't require a card.
...
Updates come from the upstream repo, [sybenx/bothy](https://github.com/sybenx/bothy). Your copy is an independent repo, not a GitHub fork, so it doesn't receive changes automatically.
