...
two hundred — the number to look at before this grows a self-service join
path, since a join path is what turns "the owner occasionally adds
somebody" into a rate strangers choose.
